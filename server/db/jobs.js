...
// getJobTable returns a query builder for the job table
const getJobTable = () => connection.table('job');

// getJobCount returns the number of jobs in the database
...
export async function getJobsForCompany(companyId) {
